...
def get_dummy_prediction(df, prediction_keys_map,prediction_backup):
    ...
    df = (df.merge(prediction_keys_map, on=["country", "brand", "dayweek","month"], how="left")
...
train_data_with_prediction = get_dummy_prediction(train_data, prediction_keys_map,prediction_backup_map)
#%%
# Check performance
