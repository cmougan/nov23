...
def main(model_pipeline, submission_timestamp, message, rolling_file_name):
    ...
    dummy_predictions = cross_val_predict(dummy_pipe, X_train, y_train, cv=3)
    y_train_transformed = y_train - dummy_predictions
    ...
    y_transformed = y - dummy_predictions
