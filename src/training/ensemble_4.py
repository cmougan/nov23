...
files = {
    ...
    "submission_2023-11-26_08-55-06_cat_old_dates.csv": 0.00996188,
    ...
    # "submission_2023-11-25_19-16-37_12m-150-estimators.csv": 0.0101000,
    # "submission_2023-11-25_19-16-37_12m-150-estimators.csv": 0.00996187
}
...
# %%
ensemble_df["inverse_error"].unique().sum()
...
# %%
ensemble_df.drop(columns=["inverse_error"]).to_csv(submission_path / "submission_ensemble_104.csv", index=False)
# %%
